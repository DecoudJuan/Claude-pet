 ...
 * falta nada más que otro register() con otro id — mirá las MacBook de abajo:
 * todas llevan la misma manzanita, lo único que cambia es la tapa.
 */
[
  { id: 'macbook',            name: 'MacBook',              lid: '#c9ccd1', badge: 'apple', badgeColor: '#8b9096' },
  { id: 'macbook-space-gray', name: 'MacBook · Space Gray', lid: '#5f646b', badge: 'apple', badgeColor: '#d9dde1' },
  { id: 'macbook-midnight',   name: 'MacBook · Midnight',   lid: '#2b3442', badge: 'apple', badgeColor: '#c3ccd8' },
  { id: 'macbook-negra',      name: 'MacBook · Negra',      lid: '#16181b', badge: 'apple', badgeColor: '#9aa0a6' },
